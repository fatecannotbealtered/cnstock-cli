...
func buildReference() referenceData {
	return referenceData{
		...
		Schemas: map[string]referenceDataSchema{
			...
			"update_report":    {Shape: "object", Fields: []string{"current_version", "latest_version", "target_version", "previous_version", "status", "update_available", "install_method", "command", "release_url", "recommended_action", "commands", "signature_status", "signature_verified", "binary_replaced", "skill_sync_command", "skill_sync_status", "preview", "post_update_action", "notes"}},
